...
class DeepBeliefNet():
    ...
    def recognize(self,true_img,true_lbl):
        ...
        pen = self.rbm_stack['vis--pen'].get_h_given_v_dir(vis)[1]
    ...
    def generate(self,true_lbl,name):
        ...
        pen = self.rbm_stack['vis--pen'].get_h_given_v_dir(input)[1]
        #pen = self.rbm_stack['hid--pen'].get_h_given_v_dir(hid)[1]
        ...
        for i in range(self.n_gibbs_gener):
            ...
            vis = self.rbm_stack['vis--pen'].get_v_given_h_dir(v)[0]
    ...
    def train_greedylayerwise(self, vis_trainset, lbl_trainset, n_iterations):
        ...
        try :
            ...
            """
            self.rbm_stack['vis--pen'].cd1(vis_trainset,n_iterations)
            ...
            final_input = self.rbm_stack["vis--pen"].get_h_given_v_dir(vis_trainset)[1]
        ...
        try :
            ...
            for it in range(n_iterations):
                ...
                for n_batch in range(int(batches)):
                    ...
                    prob_pen_wake, act_pen_wake = self.rbm_stack['vis--pen'].get_h_given_v_dir(input)
                    ...
                    prob_vis_sleep, act_vis_sleep = self.rbm_stack['vis--pen'].get_v_given_h_dir(v)
                    ...
                    pred_vis_prob = self.rbm_stack['vis--pen'].get_v_given_h_dir(act_pen_wake)[0]

                    pred_sleep_pen_activ = self.rbm_stack['vis--pen'].get_h_given_v_dir(act_vis_sleep)[1]
                    ...
                    self.rbm_stack['vis--pen'].update_generate_params(act_pen_wake,input,pred_vis_prob)
                    ...
                    self.rbm_stack['vis--pen'].update_recognize_params(prob_vis_sleep, act_vis_sleep,pred_sleep_pen_activ)
